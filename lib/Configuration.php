...
namespace GeminiCommerce\Paymentprocessor;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://payment-processor.api.gogemini.io';
    ...
    {
        $report  = 'PHP SDK (GeminiCommerce\Paymentprocessor) Debug Report:' . PHP_EOL;
